                ...
                <div class="col-lg-12">
                    <div class="row g-4 justify-content-center">
                        <?php foreach ($allNews as $newsItem) { ?>
                            <div class="col-md-6 col-lg-6 col-xl-3 col-6 mb-2">
                                <a href="<?= base_url('/news?id=' . $newsItem['id']); ?>" class="text-decoration-none">
                                    <div class="rounded position-relative fruite-item">
                                        ...
                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                            <h4 class="text-light" style="font-size: 16px;"><?= $newsItem['title']; ?></h4>
                                            <p class="text-light mb-0 mt-0" style="font-size: 12px;"><?= $newsItem['content']; ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
